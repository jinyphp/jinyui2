...
<div>
  ...
  <div class="sticky z-10 top-20 flex w-72 flex-col" style="height:90vh; top:76px;">
          ...
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                ...
                <a href="#" class="group flex gap-x-6 rounded-md p-2 text-sm font-semibold leading-6 text-black">
                  <!-- 
