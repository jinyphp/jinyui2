<header {{ $attributes->merge(['class' => 'navbar navbar-expand-lg navbar-dark bg-dark bd-navbar mb-4 ']) }}>
    <nav class="container-xxl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
        ...
        <!-- OffCanvas -->
        <!-- <div class="offcanvas-lg offcanvas-end " tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel"
            data-bs-scroll="true"> -->
        <!-- OffCanver Header -->
        ...
        <div class="offcanvas-body p-4 pt-0 p-lg-0 d-flex">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                <!-- <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" href="/shop/cart">
                            장바구니
                        </a>
                    </li>

                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" href="/shop/wishlist">
                            Wish
                        </a>
                    </li>
