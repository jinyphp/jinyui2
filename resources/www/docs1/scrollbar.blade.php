<x-www-app>
    <x-www-layout>
        ...
        <section class="pt-2 pb-md-2">
            <span
                class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill">
                Cartzilla
                component
            </span>
            <h1 class="pt-1">Scrollbar</h1>
            <p class="text-body-secondary mb-4">
                 CSS-styled replacement of browser's default scrollbar.
            </p>
        </section>
        ...
        <section class="alert d-sm-flex text-body-emphasis bg-info-subtle border-0 py-4 mb-5">
            ...
            <div class="ps-sm-3 pe-sm-5 w-100">
                <p>The custom scrollbar is powered by <a class="alert-link" href="http://grsmto.github.io/simplebar/"
                        target="_blank" rel="noreferrer">SimpleBar</a> plugin. To use a custom scrollbar, make sure to
                    include the
                ...
                <p class="mb-2">JavaScript file is linked before the closing <code>&lt;/body&gt;</code> tag and above
                    <code>theme.min.js</code> reference in your document:
                </p>
                    ...
                    <ul class="nav nav-tabs m-n2" role="tablist" style="max-width: 240px">
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link active" data-bs-toggle="tab"
                                data-bs-target="#preview-1" role="tab" aria-controls="preview-1"
                                aria-selected="true">
                    ...
                    <div class="tab-content">
                        <div id="preview-1" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                            <div class="overflow-y-auto pe-3" data-simplebar data-simplebar-auto-hide="false"
                                ...
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quas, autem aliquid nisi
                                    quia, deserunt atque
                                    alias amet totam temp aspernatur facilis veritatis repellendus tenetur, inventore ex
                                    eaque non omnis
                                    nostrum! Optio, earum illum unde dolorum illo quasi laboriosam quod alias nesciunt
                                    similique qui
                                    voluptatibus cupid dolor molestias omnis aliquid fuga pariatur fugiat.</p>
                                <p>Ad rem error ipsam suscipit? Nobis reiciendis in quae dicta consequuntur itaque,
                                    deleniti explicabo
                                    eius provident, minus voluptate doloribus porro excepturi saepe! Lorem ipsum dolor
                                    sit, amet consectetur
                                    adipisicing elit. Eum debitis accusantium, culpa soluta numquam dolore dolores,
                                    nihil explicabo voluptas
                                    impedit expedita. Doloribus nulla veniam enim ex.</p>
                                <p>Fugiat, nisi quidem nulla, ex ipsam voluptatem autem illum labore quaerat deleniti
                                    ipsa minima est.
                                    Facilis, iste hic cupiditate ea rerum quam? Hic distinctio nostrum temporibus
                                    praesentium ipsum modi
                                    laudantium eligendi aspernatur eaque explicabo asperiores doloribus nemo in omnis
                                    qui, tempora quo
                                ...
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quas, autem aliquid nisi
                                    ...
                                    similique qui
                                    voluptatibus cupid dolor molestias omnis aliquid fuga pariatur fugiat.</p>
                                <p>Amet harum blanditiis eligendi a. Unde consequatur eveniet at cumque minus ab
                                    voluptates dolorem
                                    architecto! Alias voluptas optio cupiditate facere? Facere, ipsa. Lorem ipsum dolor
                                    sit amet consectetur
                                    adipisicing elit. Voluptates quia accusamus aliquam temporibus dolorum nobis
                                    perspiciatis enim animi
                                    dolores corporis, doloremque dolore atque minima reprehenderit dignissimos velit nam
                                    doloribus fugit.
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="d-flex gap-4">
                                    <div class="card" style="min-width: 230px;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text fs-sm">Some quick example text to build on the card
                ...
                <div class="card-body position-relative z-2">
                    ...
                    <div class="tab-content">
                        <div id="preview-3" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                            <div class="overflow-y-auto pe-3" data-simplebar
                                style="max-width: 500px; max-height: 320px;">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quas, autem aliquid nisi
                                    quia, deserunt atque
                                    alias amet totam temp aspernatur facilis veritatis repellendus tenetur, inventore ex
