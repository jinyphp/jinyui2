<x-www_layout2>
  <div class="max-w-3xl mx-auto pt-10 xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
    <header id="header" class="relative z-20">
      ...
      <p class="mt-2 text-lg text-slate-700 dark:text-slate-400">Utilities for applying backdrop blur filters to an
        element.</p>
    </header>
    ...
    <div id="content-wrapper" class="relative z-20 prose prose-slate mt-12 dark:prose-dark">
      ...
      <h3 class="flex whitespace-pre-wrap not-prose" id="blurring-behind-an-element"><a
          class="group relative border-none lg:-ml-2 lg:pl-2" href="#blurring-behind-an-element"><span
            class="absolute -ml-8 hidden items-center border-0 opacity-0 group-hover:opacity-100 group-focus:opacity-100 lg:flex">​<span
              class="flex h-6 w-6 items-center justify-center rounded-md text-slate-400 shadow-sm ring-1 ring-slate-900/5 hover:text-slate-700 hover:shadow hover:ring-slate-900/10 dark:bg-slate-800 dark:text-slate-400 dark:shadow-none dark:ring-0 dark:hover:bg-slate-700 dark:hover:text-slate-200"><svg
                width="12" height="12" fill="none" aria-hidden="true">
                <path d="M3.75 1v10M8.25 1v10M1 3.75h10M1 8.25h10" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round"></path>
              </svg></span></span>Blurring behind an element</a></h3>
      <p>Use the <code>backdrop-blur-*</code> utilities to control an element’s backdrop blur.</p>
      <div class="mt-4 -mb-3">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span></code></pre>
      ...
      <p>To remove all of the backdrop filters on an element at once, use the
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
      ...
      <p>Tailwind lets you conditionally apply utility classes in different states using variant modifiers. For example,
        use
        <!-- --> <code>hover<!-- -->:<!-- -->backdrop-blur-lg</code> <!-- -->to only apply the
        <code>backdrop-blur-lg</code> utility on
        <!-- -->hover
        <!-- -->.
      </p>
      <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>backdrop-blur-sm <span class="code-highlight bg-code-highlight">hover:backdrop-blur-lg</span><span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
  <span class="token comment">&lt;!-- ... --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre>
      ...
      <p>You can also use variant modifiers to target media queries like responsive breakpoints, dark mode,
        prefers-reduced-motion, and more. For example, use <code>md:<!-- -->backdrop-blur-lg</code> to apply the
        <code>backdrop-blur-lg</code> utility at only medium screen sizes and above.</p>
      <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>backdrop-blur-sm <span class="code-highlight bg-code-highlight">md:backdrop-blur-lg</span><span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
  <span class="token comment">&lt;!-- ... --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre>
      ...
      <p>By default, Tailwind includes a handful of general purpose <code>backdrop-blur</code> utilities. You can
        customize these values by editing <code>theme.backdropBlur</code> or <code>theme.extend.backdropBlur</code> in
        your <code>tailwind.config.js</code> file.</p>
...
</span><span class="token language-js inserted"><span class="token plain">      </span><span class="token literal-property property">backdropBlur</span><span class="token operator">:</span><span class="token plain"> </span><span class="token punctuation">{</span><span class="token plain"></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
    ...
    <footer class="text-sm leading-6 mt-12">
      <div class="mb-10 text-slate-700 font-semibold flex items-center dark:text-slate-200"><a
          class="group flex items-center hover:text-slate-900 dark:hover:text-white" href="/docs/sepia"><svg
            viewBox="0 0 3 6"
          ...
          </svg>Sepia</a><a class="group ml-auto flex items-center hover:text-slate-900 dark:hover:text-white"
          href="/docs/backdrop-brightness">Backdrop Brightness<svg viewBox="0 0 3 6"
      ...
      <div class="pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500 dark:border-slate-200/5">
        <div class="mb-6 sm:mb-0 sm:flex">
          ...
          href="https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-blur.mdx">Edit this
          page on GitHub</a>
      </div>
    </footer>
    <div
      ...
      <div class="px-8">
        ...
        <ul class="text-slate-700 text-sm leading-6">
          ...
          <li><a href="#basic-usage"
              ...
              usage</a></li>
          <li class="ml-4"><a href="#blurring-behind-an-element"
              ...
              </svg>Blurring behind an element</a></li>
