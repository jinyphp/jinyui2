<x-www_layout2>
  <div class="max-w-3xl mx-auto pt-10 xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
    <header id="header" class="relative z-20">
      ...
      <p class="mt-2 text-lg text-slate-700 dark:text-slate-400">Utilities for controlling the cursor style when
        hovering over an element.</p>
    </header>
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr>
                ...
                <th
                  class="sticky z-10 top-0 text-sm leading-6 font-semibold text-slate-700 bg-white p-0 dark:bg-slate-900 dark:text-slate-300 hidden sm:table-cell">
                  <div class="py-2 pl-2 border-b border-slate-200 dark:border-slate-400/20 pr-2">Properties</div>
                </th>
                <th
                  class="sticky z-10 top-0 text-sm leading-6 font-semibold text-slate-700 bg-white p-0 dark:bg-slate-900 dark:text-slate-300">
                  <div class="py-2 pl-2 border-b border-slate-200 dark:border-slate-400/20"><span
                      class="sr-only">Preview</span>&nbsp;</div>
                </th>
              </tr>
            </thead>
            <tbody class="align-baseline">
              <tr style="cursor: auto;">
                <td translate="no"
                  ...
                  cursor-auto</td>
                <td translate="no"
                  class="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 hidden sm:table-cell sm:pr-2">
                  cursor: auto;
                </td>
                <td class="align-middle "><img class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-auto.svg">
                </td>
              </tr>
              <tr style="cursor: default;">
                <td translate="no"
                  ...
                  cursor-default</td>
                <td translate="no"
                  class="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10 hidden sm:table-cell sm:pr-2">
                  cursor: default;
                </td>
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-default.svg"></td>
              </tr>
              <tr style="cursor: pointer;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-pointer.svg"></td>
              </tr>
              <tr style="cursor: wait;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-wait.svg"></td>
              </tr>
              <tr style="cursor: text;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-text.svg"></td>
              </tr>
              <tr style="cursor: move;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-move.svg"></td>
              </tr>
              <tr style="cursor: help;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-help.svg"></td>
              </tr>
              <tr style="cursor: not-allowed;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-not-allowed.svg"></td>
              </tr>
              <tr style="cursor: none;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"></td>
              </tr>
              <tr style="cursor: context-menu;">
                <td translate="no"
                  class="py-2 pr-2 font-mono font-medium text-xs leading-6 text-sky-500 whitespace-nowrap dark:text-sky-400 border-t border-slate-100 dark:border-slate-400/10">
                  cursor-context-menu</td>
                <td translate="no"
                  class="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10 hidden sm:table-cell sm:pr-2">
                  cursor: context-menu;
                </td>
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-context-menu.svg"></td>
              </tr>
              <tr style="cursor: progress;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-progress.svg"></td>
              </tr>
              <tr style="cursor: cell;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-cell.svg"></td>
              </tr>
              <tr style="cursor: crosshair;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-crosshair.svg"></td>
              </tr>
              <tr style="cursor: vertical-text;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-vertical-text.svg"></td>
              </tr>
              <tr style="cursor: alias;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-alias.svg"></td>
              </tr>
              <tr style="cursor: copy;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-copy.svg"></td>
              </tr>
              <tr style="cursor: no-drop;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-no-drop.svg"></td>
              </tr>
              <tr style="cursor: grab;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-grab.svg"></td>
              </tr>
              <tr style="cursor: grabbing;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-grabbing.svg"></td>
              </tr>
              <tr style="cursor: all-scroll;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-all-scroll.svg"></td>
              </tr>
              <tr style="cursor: col-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-col-resize.svg"></td>
              </tr>
              <tr style="cursor: row-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-row-resize.svg"></td>
              </tr>
              <tr style="cursor: n-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-n-resize.svg"></td>
              </tr>
              <tr style="cursor: e-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-e-resize.svg"></td>
              </tr>
              <tr style="cursor: s-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-s-resize.svg"></td>
              </tr>
              <tr style="cursor: w-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-w-resize.svg"></td>
              </tr>
              <tr style="cursor: ne-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-ne-resize.svg"></td>
              </tr>
              <tr style="cursor: nw-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-nw-resize.svg"></td>
              </tr>
              <tr style="cursor: se-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-se-resize.svg"></td>
              </tr>
              <tr style="cursor: sw-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-sw-resize.svg"></td>
              </tr>
              <tr style="cursor: ew-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-ew-resize.svg"></td>
              </tr>
              <tr style="cursor: ns-resize;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-ns-resize.svg"></td>
              </tr>
              <tr style="cursor: nesw-resize;">
                <td translate="no"
                  class="py-2 pr-2 font-mono font-medium text-xs leading-6 text-sky-500 whitespace-nowrap dark:text-sky-400 border-t border-slate-100 dark:border-slate-400/10">
                  cursor-nesw-resize</td>
                <td translate="no"
                  class="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10 hidden sm:table-cell sm:pr-2">
                  cursor: nesw-resize;
                </td>
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-nesw-resize.svg"></td>
              </tr>
              <tr style="cursor: nwse-resize;">
                <td translate="no"
                  class="py-2 pr-2 font-mono font-medium text-xs leading-6 text-sky-500 whitespace-nowrap dark:text-sky-400 border-t border-slate-100 dark:border-slate-400/10">
                  cursor-nwse-resize</td>
                <td translate="no"
                  class="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10 hidden sm:table-cell sm:pr-2">
                  cursor: nwse-resize;
                </td>
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-nwse-resize.svg"></td>
              </tr>
              <tr style="cursor: zoom-in;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-zoom-in.svg"></td>
              </tr>
              <tr style="cursor: zoom-out;">
                ...
                <td class="align-middle border-t border-slate-100 dark:border-slate-400/10"><img
                    class="w-6 h-6 mx-auto drop-shadow" src="/img/cursors/cursor-zoom-out.svg"></td>
              </tr>
            </tbody>
          </table>
    ...
    <div id="content-wrapper" class="relative z-20 prose prose-slate mt-12 dark:prose-dark">
      ...
      <h3 class="flex whitespace-pre-wrap not-prose" id="setting-the-cursor-style"><a
          class="group relative border-none lg:-ml-2 lg:pl-2" href="#setting-the-cursor-style"><span
            class="absolute -ml-8 hidden items-center border-0 opacity-0 group-hover:opacity-100 group-focus:opacity-100 lg:flex">​<span
              class="flex h-6 w-6 items-center justify-center rounded-md text-slate-400 shadow-sm ring-1 ring-slate-900/5 hover:text-slate-700 hover:shadow hover:ring-slate-900/10 dark:bg-slate-800 dark:text-slate-400 dark:shadow-none dark:ring-0 dark:hover:bg-slate-700 dark:hover:text-slate-200"><svg
                width="12" height="12" fill="none" aria-hidden="true">
                <path d="M3.75 1v10M8.25 1v10M1 3.75h10M1 8.25h10" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round"></path>
              </svg></span></span>Setting the cursor style</a></h3>
      <p>Use the <code>cursor-*</code> utilities to control which cursor is displayed when hovering over an element.</p>
      <div class="mt-4 -mb-3">
        <div class="not-prose mb-4">
          <div class="flex space-x-2"><svg class="flex-none w-5 h-5" viewBox="0 0 20 20" fill="none" stroke-width="1.5"
            ...
            <p class="text-slate-700 text-sm font-medium dark:text-slate-200">Hover over each button to see the cursor
              change</p>
          </div>
        </div>
        <div class="not-prose relative bg-slate-50 rounded-xl overflow-hidden dark:bg-slate-800/25">
          ...
          <div class="relative rounded-xl overflow-auto p-8">
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-0 items-center justify-around">
              ...
              <button type="button"
                class="w-full sm:w-auto py-2 px-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 dark:disabled:bg-indigo-800 text-white dark:disabled:text-indigo-400 text-sm font-semibold rounded-md shadow focus:outline-none cursor-progress"
                tabindex="-1">
                Saving...
              </button>
              <button type="button"
                class="w-full sm:w-auto py-2 px-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 dark:disabled:bg-indigo-800 text-white dark:disabled:text-indigo-400 text-sm font-semibold rounded-md shadow focus:outline-none cursor-not-allowed"
                tabindex="-1" disabled="">
                Confirm
              </button>
            </div>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">&gt;</span></span></code></pre>
      ...
      <p>Tailwind lets you conditionally apply utility classes in different states using variant modifiers. For example,
        use <code>focus:cursor-auto</code> to only apply the <code>cursor-auto</code> utility on focus.</p>
      <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>cursor-not-allowed <span class="code-highlight bg-code-highlight">focus:cursor-auto</span><span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
      ...
      <p>You can also use variant modifiers to target media queries like responsive breakpoints, dark mode,
        prefers-reduced-motion, and more. For example, use <code>md:cursor-auto</code> to apply the
        <code>cursor-auto</code> utility at only medium screen sizes and above.</p>
      <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>cursor-not-allowed <span class="code-highlight bg-code-highlight">md:cursor-auto</span><span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
  <span class="token comment">&lt;!-- ... --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre>
      ...
      <p>By default, Tailwind includes <code>cursor</code> utilities for many built in options. You can customize these
        values by editing <code>theme.cursor</code> or <code>theme.extend.cursor</code> in your
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
    ...
    <footer class="text-sm leading-6 mt-12">
      <div class="mb-10 text-slate-700 font-semibold flex items-center dark:text-slate-200"><a
          class="group flex items-center hover:text-slate-900 dark:hover:text-white" href="/docs/appearance"><svg
            viewBox="0 0 3 6"
          ...
          </svg>Appearance</a><a class="group ml-auto flex items-center hover:text-slate-900 dark:hover:text-white"
          href="/docs/caret-color">Caret Color<svg viewBox="0 0 3 6"
      ...
      <div class="pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500 dark:border-slate-200/5">
        <div class="mb-6 sm:mb-0 sm:flex">
          ...
          href="https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/cursor.mdx">Edit this page on
          GitHub</a>
      </div>
    </footer>
    <div
      ...
      <div class="px-8">
        ...
        <ul class="text-slate-700 text-sm leading-6">
          ...
          <li><a href="#basic-usage"
              ...
              usage</a></li>
          <li class="ml-4"><a href="#setting-the-cursor-style"
              ...
              </svg>Setting the cursor style</a></li>
